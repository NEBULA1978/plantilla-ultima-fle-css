...
# Formatear el archivo HTML usando Prettier (asegúrate de tener Prettier instalado)
prettier --write "$archivo_html"

echo "El archivo HTML ha sido formateado correctamente."
